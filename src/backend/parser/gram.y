...
/* PGXC - added DISTRIBUTE, DIRECT, HASH, REPLICATION, ROUND ROBIN, COORDINATOR, CLEAN, MODULO, NODE */
...
/* PGXC_BEGIN */
	DICTIONARY DIRECT DISABLE_P DISCARD DISTINCT DISTRIBUTE DO DOCUMENT_P DOMAIN_P DOUBLE_P DROP
/* PGXC_END */
